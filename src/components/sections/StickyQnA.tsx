  ...
  return (
    <section className="bg-sp-bg-dark relative border-y border-white/5 pb-16 lg:pb-0">
      <div className="container mx-auto px-5 md:px-8 lg:px-12">
        <div className="relative flex flex-col gap-10 md:gap-16 lg:flex-row lg:gap-24 lg:py-40">
          {/* Sticky Left Column */}
          ...
          <div className="relative z-20 flex flex-col gap-5 md:gap-6 lg:w-[55%] lg:gap-5 md:gap-8 md:gap-12 lg:pb-[20vh]">
            {items.map((item, i) => (
...
function StackedCard({ item, index, total }: { item: FaqItem; index: number; total: number }) {
  return (
    <motion.div
      ...
      className="hover:border-sp-accent/40 bg-sp-bg-medium border-sp-border-light sticky overflow-x-clip rounded-3xl border p-5 md:p-10 lg:p-14 shadow-2xl transition-colors duration-500"
      style={{
    ...
    >
      ...
      <div className="bg-sp-accent/5 pointer-events-none absolute top-0 right-0 h-64 w-64 translate-x-1/3 -translate-y-1/2 rounded-full blur-[120px]" />

      <div className="relative z-10 flex h-full flex-col justify-between gap-5 md:gap-8">
        ...
        <div>
          <h3 className="text-sp-text-dark mb-6 text-xl leading-[1.3] font-bold tracking-tight md:text-3xl lg:text-4xl">
            {item.q}
          </h3>
