...
function StackedCard({ item, index, total }: { item: FaqItem; index: number; total: number }) {
  return (
    <motion.div
      ...
      className="hover:border-sp-accent/30 bg-sp-bg-medium sticky overflow-x-hidden rounded-[2.5rem] border border-white/5 p-10 shadow-2xl transition-colors duration-500 md:p-14"
      style={{
