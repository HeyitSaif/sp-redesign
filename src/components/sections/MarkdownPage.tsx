...
export function MarkdownPage({ content, frontmatter, locale }: MarkdownPageProps) {
  ...
  return (
    <div className="relative flex w-full flex-col overflow-x-hidden pt-56 md:pt-72">
      <FloatiesBackground />
      {/* Dynamic Header */}
      <section className="bg-sp-bg-dark relative flex min-h-[50vh] items-center overflow-x-hidden border-b border-white/5 py-32 md:py-48 lg:py-64">
      ...
      {/* Global CTA */}
      <section className="bg-sp-bg-dark relative mt-32 overflow-x-hidden border-t border-white/5 py-48 md:py-64 lg:py-80">
        ...
        <div className="relative z-10 container mx-auto max-w-5xl px-10 text-center md:px-20 lg:px-32">
          <Reveal>
            ...
            <Link
              ...
              className="bg-sp-accent group hover:bg-sp-accent-dark relative inline-flex items-center justify-center gap-4 overflow-x-hidden rounded-full px-16 py-8 text-2xl font-bold tracking-wide text-white shadow-[0_4px_40px_-8px_rgba(255,112,67,0.5)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_12px_50px_-8px_rgba(255,112,67,0.7)] active:scale-95"
            >
