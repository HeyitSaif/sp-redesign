...
export default async function HomePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <div className="bg-sp-bg-dark flex w-full flex-col overflow-x-hidden text-white">
      ...
      <section className="bg-sp-bg-light text-sp-text-dark relative border-y border-white/5 py-24 md:py-32 lg:py-40">
        <div className="container mx-auto px-6 md:px-12">
          <div className="mx-auto mb-20 max-w-4xl text-center">
            <Reveal>
              <h2 className="text-sp-text-dark mb-14 text-5xl font-black tracking-tight md:text-7xl lg:text-8xl">
          ...
          <div className="grid gap-10 pt-10 md:grid-cols-3 md:gap-12 lg:gap-14">
            {[
              {
                title: isDe
      ...
      <section className="bg-sp-bg-medium text-sp-text-dark relative overflow-x-hidden py-24 md:py-32 lg:py-40">
      ...
      <section
        id="contact"
        className="bg-sp-bg-dark relative overflow-x-hidden py-24 md:py-32 lg:py-40"
      >
      ...
      <section className="bg-sp-bg-dark relative overflow-x-hidden py-24 md:py-32">
        {/* Accent background overlay per HTML */}
        <div className="bg-sp-accent absolute inset-0 opacity-20 mix-blend-multiply" />
        <div className="absolute inset-0 bg-[url('https://solutionplus.io/wp-content/uploads/2025/09/Gradient-28-scaled.jpg')] bg-cover bg-center opacity-30 mix-blend-overlay" />
